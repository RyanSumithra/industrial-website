...
<style>
    ...
    /* 3. Filter Section */
    .filter-section { background: #080808; padding: 40px 0; border-bottom: 1px solid #1a1a1a; position: sticky; top: 0; z-index: 50; }
    ...
    .filter-stats { display: flex; justify-content: center; gap: 40px; border-top: 1px solid #222; padding-top: 30px; }
    .stat-bubble span:first-child { font-weight: 800; color: #fff; font-size: 1.2rem; display: block; }
    .stat-bubble span:last-child { color: #666; font-size: 0.9rem; }
